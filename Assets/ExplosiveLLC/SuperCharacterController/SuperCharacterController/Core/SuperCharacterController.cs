...
public class SuperCharacterController:MonoBehaviour
{
	...
	/// </summary>
	// [SerializeField] removido: o atributo so' vale em CAMPO, nunca em declaracao de
	// tipo, e o compilador atual trata isso como ERRO (CS0592) - o pacote e' antigo.
	// Um erro de compilacao aqui trava o projeto INTEIRO, mesmo este controller nao
	// sendo usado (o Player usa o CharacterController da Unity). Removido em vez de
	// apagar a pasta pra nao mexer no resto do pacote, de onde vem a animacao de
	// ataque (Knight@Attack1).
