...
- `PauseMenu` — `UIDocument` global com `PauseMenuController.cs`. `Esc` abre
  uma tela cheia de pausa usando o logo `logo_sub_rust_blood.png`; Continuar
  retoma, Voltar ao menu carrega `MenuPrincipal`, Salvar é placeholder honesto
  para o sistema futuro e Sair fecha o jogo/build.
